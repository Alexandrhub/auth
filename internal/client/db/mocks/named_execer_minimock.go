...
//go:generate minimock -i github.com/alexandrhub/auth/internal/client/db.NamedExecer -o ./mocks/named_execer_minimock.go -n NamedExecerMock
...
import (
	...
	mm_db "github.com/alexandrhub/auth/internal/client/db"

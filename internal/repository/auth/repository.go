...
import (
	...
	modelRepo "github.com/alexandrhub/auth/internal/repository/auth/model"
)
...
// Create Делаем запрос на добавление данных в таблицу users
...
// Get Делаем запрос на получение измененной записи из таблицы users
func (r *repo) Get(ctx context.Context, userID int64) (*model.User, error) {
	...
	err = r.db.DB().QueryRowContext(ctx, q, args...).Scan(
		&user.UserCreate.UserUpdate.ID,
		&user.UserCreate.UserUpdate.Name,
...
// Update Делаем запрос на обновление данных
...
// Delete Делаем запрос на удаление данных

...
test:
	go clean -testcache
	go test ./... -covermode count -coverpkg=github.com/alexandrhub/auth/internal/api/...,github.com/alexandrhub/auth/internal/service/... -count 5

test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/alexandrhub/auth/internal/api/...,github.com/alexandrhub/auth/internal/service/... -count 5
